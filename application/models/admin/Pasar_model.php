	...
	function insert_data() {
		...
		if (!empty($_FILES['userfile']['name'])) {
			$data = array(
					...
					'pasar_kode'			=> strtoupper(trim($this->input->post('kode', 'true'))),
					'pasar_nama'			=> strtoupper(trim($this->input->post('nama', 'true'))),
					'pasar_thn_berdiri'		=> trim($this->input->post('tahun', 'true')),
					'pasar_alamat'			=> strtoupper(trim($this->input->post('alamat', 'true'))),
					'provinsi_id'			=> $this->input->post('provinsi_id', 'true'),
					'kabupaten_id'			=> $this->input->post('kab_id', 'true'),
					'kecamatan_id'			=> $this->input->post('kec_id', 'true'),
					'desa_id'				=> $this->input->post('desa_id', 'true'),
					'pasar_lat'				=> trim($this->input->post('latitude', 'true')),
					'pasar_long'			=> trim($this->input->post('longitude', 'true')),
					'pasar_luas_tnh'		=> trim($this->input->post('luas_tanah', 'true')),
					'pasar_luas_bangun'		=> trim($this->input->post('luas_bangunan', 'true')),
					'pasar_jml_lantai'		=> trim($this->input->post('jml_lantai', 'true')),
					'pasar_jml_blok'		=> trim($this->input->post('jml_blok', 'true')),
					'pasar_jml_ruko'		=> trim($this->input->post('jml_ruko', 'true')),
					'pasar_jml_kios'		=> trim($this->input->post('jml_kios', 'true')),
					'pasar_jml_los'			=> trim($this->input->post('jml_los', 'true')),
					'pasar_jml_dasaran'		=> trim($this->input->post('jml_dasaran', 'true')),
					'pasar_jenis'			=> $this->input->post('rdJenis', 'true'),
					'kelas_id'				=> $this->input->post('lstKelas', 'true'),
					'pasar_operasional'		=> $this->input->post('rdOperasional', 'true'),
					'bentuk_id'				=> $this->input->post('rdBentuk', 'true'),
					'kondisi_id'			=> $this->input->post('rdKondisi', 'true'),
					'kepemilikan_id'		=> $this->input->post('rdLahan', 'true'),
					'pasar_omzet_hari'		=> $this->input->post('omzet_harian', 'true'),
					'pasar_omzet_minggu'	=> $this->input->post('omzet_mingguan', 'true'),
					'pasar_omzet_bulan'		=> $this->input->post('omzet_bulanan', 'true'),
					'pasar_omzet_tahun'		=> $this->input->post('omzet_tahunan', 'true'),
					'pasar_parkir'			=> $this->input->post('chkParkir', 'true'),
					'pasar_mck'				=> $this->input->post('chkMCK', 'true'),
					'pasar_tps'				=> $this->input->post('chkTPS', 'true'),
					'pasar_mushola'			=> $this->input->post('chkIbadah', 'true'),
					'pasar_pengelola'		=> $this->input->post('rdKelola', 'true'),
					'pasar_nip'				=> $this->input->post('nip', 'true'),
					'pasar_koordinator'		=> strtoupper(trim($this->input->post('nama_koordinator', 'true'))),
