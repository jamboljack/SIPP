...
class Kepemilikan_model extends CI_Model {
	var $table 			= 'sipp_kepemilikan';
    var $column_order 	= array(null, 'kepemilikan_nama', null);
    var $column_search 	= array('kepemilikan_nama');
    var $order 			= array('kepemilikan_nama' => 'asc');
