...
<script>
    function hapusData(item_id) {
        var id = item_id;
        swal({
            title: 'Anda Yakin ?',
            text: 'Data Item ini Akan di Hapus !',type: 'warning',
            ...
            window.location.href="<?php echo site_url('admin/skrd/deletedataitem/'.$this->uri->segment(4)); ?>"+"/"+id
        });
    }
</script>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a onclick="hapusData(<?php echo $item_id; ?>)">
