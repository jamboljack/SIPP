                        ...
                        <input type="hidden" name="jenis_kode" id="jenis_kode" value="<?php echo set_value('jenis_kode'); ?>">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="alamat" rows="2" readonly><?php echo $detailpenduduk->penduduk_alamat.', DESA '.$detailpenduduk->desa_nama.' KEC. '.$detailpenduduk->kecamatan_nama; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Foto</label>
                                    <div class="col-md-9">
                                        <?php if (!empty($detailpenduduk->penduduk_foto)) { ?>
                                        <img src="<?php echo base_url(); ?>penduduk_image/<?php echo $detailpenduduk->penduduk_foto; ?>" width="15%">
                                        <?php } else { ?>
                                ...
                                <h3 class="form-section">Batas-Batas</h3>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">Utara</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Batas Utara" name="utara" value="<?php echo set_value('utara'); ?>" autocomplete="off" required>
                                        <div class="form-control-focus"></div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">Selatan</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Batas Selatan" name="selatan" value="<?php echo set_value('selatan'); ?>" autocomplete="off" required>
                                        <div class="form-control-focus"></div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">Timur</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Batas Timur" name="timur" value="<?php echo set_value('timur'); ?>" autocomplete="off" required>
                                        <div class="form-control-focus"></div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">Barat</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Batas Barat" name="barat" value="<?php echo set_value('barat'); ?>" autocomplete="off" required>
                                        <div class="form-control-focus"></div>
                                    </div>
                                </div>
                            </div>
