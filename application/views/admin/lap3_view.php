<div class="page-content-wrapper">
    <div class="page-content">            
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="<?php echo site_url('admin/lap3/preview/'.$Report['Pasar'].'/'.$Report['Tempat'].'/'.$Report['Bulan'].'/'.$Report['Tahun'].'/'.$Report['Status']); ?>" class="btn blue" target="_blank"><i class="fa fa-print"></i> Print Preview
                </a>
