...
<table width="100%" border="1" align="center">
    ...
    <tr>
        <td colspan="6">
            ...
            <tr>
                <td colspan="5">2. Apabila SKR ini tidak atau kurang dibayar lewat waktu paling lama 30 hari setelah SKR diterima</td>
            </tr>
            <tr>
                <td colspan="5">    atau (tanggal jatuh tempo) dikenakan sanksi administrasi berupa bunga sebesar 2% per bulan</td>
            </tr>
            </table>
        </td>
    </tr>
