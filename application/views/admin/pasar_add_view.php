                        ...
                        <input type="hidden" class="desa_id" name="desa_id" value="<?php echo set_value('desa_id'); ?>">                        
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" class="form-control" placeholder="Enter Kode Pasar" name="kode" value="<?php echo set_value('kode'); ?>" maxlength="3" autocomplete="off" required autofocus>
                                ...
                                <div class="form-group form-md-checkboxes"">
                                    ...
                                    <div class="md-radio-inline col-md-9">
                                        <div class="md-radio">
                                            <input type="radio" id="radio16" name="rdJenis" class="md-radiobtn" value="T" <?php echo set_checkbox('rdJenis', 'T'); ?> required>
                                            <label for="radio16">
                                                <span></span>
                                        ...
                                        <div class="md-radio">
                                            <input type="radio" id="radio17" name="rdJenis" class="md-radiobtn" value="H" <?php echo set_checkbox('rdJenis', 'H'); ?>>
                                            <label for="radio17">
                                                <span></span>
                                                <span class="check"></span>
